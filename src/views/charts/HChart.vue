  ...
  <div class="content">
    <div class="main">
      <div class="left">
        <div class="left-name">
          <div>
            <span class="item">{{params.province || display || '--'}}</span>银行罚单按处罚机关分布
          </div>
        </div>
        <div class="chart-info" ref="chart" id="chart">
          <el-table :data="tableData" border style="width: 100%" class="custom-table">
            ...
            <el-table-column fixed prop="punishment_organ_name" label="处罚机关"></el-table-column>
    ...
    <div class="right">
      <div class="title">
        <span>{{params.province || display || '--'}}</span>
      ...
      >
        ...
        <el-table-column prop="punishment_organ_name" label="处罚机关"></el-table-column>
