  ...
  <div class="content">
    <div class="main">
      <div class="left">
        <div class="left-name">
          <div>
            <span class="item">{{display || formatterTitle(params.topText)}}</span>合计罚没金额排名
          </div>
    ...
    <div class="right">
      ...
      >
        ...
        <el-table-column prop="branch_name" label="银行名称"></el-table-column>
        <el-table-column prop="sum_fine_unit" label="机构罚没"></el-table-column>
        <el-table-column prop="sum_fine_individual" label="个人罚没"></el-table-column>
      ...
      this.requestSaas('/ssssindicators/getStatisticsData', 
      {
        ...
        if (this.tableData.length > 0) {
          ...
          for (
            ...
            xData.push(this.tableData[i].branch_name)
            yData.push(this.tableData[i].sum_fine_all)
          }
